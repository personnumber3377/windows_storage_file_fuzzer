...
#pragma optimize("", off)  // Disable optimizations for this section
...
void FuzzStgOpenStorage(const std::wstring& filePath) {
    ...
    HRESULT hr = StgOpenStorageEx(
        ...
        STGFMT_ANY,             // Open compound document format
        0,                          // Reserved
...
#pragma optimize("", on)  // Disable optimizations for this section
...
int main(int argc, char** argv) {
    ...
    while (1) { // This is needed for the in_app persistence mode...
